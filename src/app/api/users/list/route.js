...
export async function GET(req) {
  ...
  await connectDB();
  const users = await User.find({}, 'name email role department designation reportingManagers basic_salary allowance leave_limit previousLeavesAvailed createdAt')
    .lean();
